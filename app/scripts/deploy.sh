#!/bin/bash
# agrimaan Application Deployment Script
# This script deploys the agrimaan application on a prepared server
...
echo -e "${GREEN}===== agrimaan Application Deployment =====${NC}"
...
(crontab -l 2>/dev/null; echo "0 2 * * * /opt/agrimaan/scripts/backup.sh") | crontab -
